...
public class MainPage {
    public Button messageClose= new Button(By.xpath("//span[@class='cookies-message-close']"),"message close");
    ...
    public Button dayWeek = new Button(By.xpath("//button[contains(text(),'22')]"),"day week");
